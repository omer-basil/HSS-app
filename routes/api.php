...
use App\Http\Controllers\Staff\TagController;
...
Route::group(['prefix' => '{language}', 'middleware' => 'SetLocale'], function () {
    ...
    Route::middleware('auth:api')->group(function(){
        ...
        Route::apiResource('/items/{item:id}/rating', RatingController::class);
        Route::apiResource('/items/{item:id}/review', ReviewController::class);
